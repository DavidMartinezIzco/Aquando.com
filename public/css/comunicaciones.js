function actualizarConexiones( nombre, pwd ) {
    ...
    $( document )
        .ready( function () {
            $.ajax( {
                type: 'GET',
                url: 'http://localhost/Aquando/public/A_Conexiones.php?nombre=' + nombre + '&pwd=' + pwd + '&opcion=conex',
...
function nombrarEstacion( estacion ) {
    ...
    $( document )
        .ready( function () {
            $.ajax( {
                type: 'GET',
                url: 'http://localhost/Aquando/public/A_Conexiones.php?estacion=' + estacion + '&opcion=nom',
