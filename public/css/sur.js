    ...
    if ( entorno == "general" ) {
        ...
        $( document )
            .ready( function () {
                $.ajax( {
                    type: 'GET',
                    url: 'http://localhost/Aquando/public/A_Sur.php?caso=general&nombre=' + nombre + '&pwd=' + pwd,
    ...
    if ( entorno == "estacion" ) {
        $( document )
            .ready( function () {
                $.ajax( {
                    type: 'GET',
                    url: 'http://localhost/Aquando/public/A_Sur.php?caso=estacion&estacion=' + estacion,
                    success: function ( alarmas ) {
                        document.getElementById( "alarmasSur" )
                            .innerHTML = alarmas;
                    },
