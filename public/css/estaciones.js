...
function actualizar( id_estacion ) {
    ...
    $( document )
        .ready( function () {
            $.ajax( {
                type: 'GET',
                url: 'http://localhost/Aquando/public/A_Estacion.php?opcion=actualizar&estacion=' + id_estacion + '&tipo=todos',
                success: function ( datos ) {
                    filtrarDatos( datos );
                },
                error: function () {
    ...
    $( document )
        .ready( function () {
            $.ajax( {
                ...
                data: { arrTags: arrTags },
                contentType: 'application/json;charset=utf-8',
                url: 'http://localhost/Aquando/public/A_Estacion.php?opcion=trends&estacion=' + id_estacion + '&tipo=todos',
                success: function ( trends ) {
                    todoTrends = trends;
                    montarWidgetsDigi();
                    montarWidgetsAnalogicos();
...
=======
            if ( document.getElementById( "panelNegro" + nombreDato + "Dia" ) && todoTrends[ tag ] !== undefined ) {
                document.getElementById( "panelNegro" + nombreDato + "Dia" )
                    .innerHTML = 'Acumulado:' + todoTrends[ tag ][ 'max' ][ 0 ];
>>>>>>> Stashed changes
            } else {
                document.getElementById( "panelNegro" + nombreDato + "Dia" )
                    .innerHTML = 'sin trends de señal';
            }
...
function fotoEstacion( id_estacion ) {
    $( document )
        .ready( function () {
            $.ajax( {
                type: 'GET',
                url: 'http://localhost/Aquando/public/A_Estacion.php?opcion=foto&estacion=' + id_estacion,
