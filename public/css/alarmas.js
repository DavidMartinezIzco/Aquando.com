        ...
        $( document )
            .ready( function () {
                $.ajax( {
                    ...
                    url: '/Aquando.com/A_Alarmas.php?funcion=actualizar&nombre=' + nombre + '&pwd=' + pwd + '&emp=' + emp + '&sentido=' + sentido + '&orden=' + orden + '&fechaInicio=' + fechaInicio + '&fechaFin=' + fechaFin,
        ...
        $( document )
            .ready( function () {
                $.ajax( {
                    ...
                    url: '/Aquando.com/A_Alarmas.php?funcion=estacion&sentido=' + sentido + '&orden=' + orden + '&estacion=' + id_estacion + '&fechaInicio=' + fechaInicio + '&fechaFin=' + fechaFin,
                    success: function ( alarmas ) {
                        document.getElementById( "tablaAlarmas" )
                            .innerHTML = alarmas;
                    },
    ...
    $( document )
        .ready( function () {
            $.ajax( {
                ...
                url: '/Aquando.com/A_Alarmas.php?funcion=reconocer&alarma=' + id_alarma + '&nombre=' + sessionStorage.getItem( 'nousu' ) + '&fecha_ack=',
                success: function () {
                    actualizar( null );
                },
                error: function () {
