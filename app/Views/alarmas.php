...
<main id="conPrincipal" style="width:100%; border-radius:10px;">
    <div id="zonaOpciones">
        ...
        <div id="acciones">
            ...
            <button id="btnControl" class="btnOp" style="background-color: rgb(1, 168, 184);border:2px solid blue;" value="print" onclick="imprimir()" name="btnControlPrint"><i class="fas fa-print"></i></button>
            <button id="btnControl" class="btnOp" style="background-color: darkseagreen;border:2px solid darkgreen;" value="print" onclick="exportarCSV()" name="btnControlPrint"><i class="fas fa-file-excel"></i></button>
        </div>
    </div>
    <div id="zonaAlarmas">
