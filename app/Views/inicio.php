...
<body>
    ...
    <div id="contenido" style="padding-top: 3.8%; padding-left:0%; color:lightgrey;height:1000px;" onclick="cerrarMenuEsp();">
        ...
        if (!isset($_SESSION['nombre']) && $_SESSION['mensajeDesc'] == true) {
            echo '<main id="conPrincipal" style="width:100%;border-radius:10px; margin-top:1%">';
            //echo "<h1 id='txtDesconectado' style='width:30%;margin:25% 40%;color:grey; transition:1.5s;opacity:60%'>Desconectado</h1>";
            //echo '<iframe style="width:100%;height:100%" id="dateandoembed" src="https://www.dateando.tech/"></iframe>';
