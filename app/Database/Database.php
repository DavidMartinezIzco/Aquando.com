...
class Database
{
    ...
    {
        return $this->conexion = pg_connect("host=$this->host port=$this->port dbname=$this->dbname user=$this->user password=$this->password");
    }
    ...
    //se usa en comunicaciones y en inicio para el mapa
